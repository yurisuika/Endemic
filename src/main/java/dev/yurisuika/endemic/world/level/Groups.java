...
public class Groups {
    ...
    public static Group TALL_MANGROVE = new Group(
            1.0D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
    ...
    public static Group MANGROVE = new Group(
            1.0D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
    ...
    public static Group STUNTED_TALL_MANGROVE = new Group(
            0.5D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
            ...
            new Group.Entry(
                    "endemic:stunted_tall_mangrove",
                    0.85D,
                    new Group.Entry.Neighbors(false, false)
            )
    );
    public static Group STUNTED_MANGROVE = new Group(
            0.5D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
            ...
            new Group.Entry(
                    "endemic:stunted_mangrove",
                    1.0D,
                    new Group.Entry.Neighbors(false, false)
            )
    );
    public static Group MANGROVE_SHRUB = new Group(
            0.25D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
            ...
            new Group.Conditions(
                    ...
                    new Group.Conditions.Climate(
                            new Group.Conditions.Climate.Temperature(
                                    new Group.Conditions.Climate.Temperature.Optimum(0.5D, 1.1D),
                                    new Group.Conditions.Climate.Temperature.Tolerance(0.1D, 1.5D)
                            ),
                            new Group.Conditions.Climate.Downfall(
                                    new Group.Conditions.Climate.Downfall.Optimum(0.6D, 1.2D),
                                    new Group.Conditions.Climate.Downfall.Tolerance(0.2D, 1.6D)
                            )
                    )
            ),
            new Group.Entry(
                    "endemic:mangrove_shrub",
                    1.0D,
                    new Group.Entry.Neighbors(false, false)
            )
    );
    public static Group CHERRY = new Group(
            1.0D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
    ...
    public static Group STUNTED_CHERRY = new Group(
            0.5D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
            ...
            new Group.Entry(
                    "endemic:stunted_cherry",
                    1.0D,
                    new Group.Entry.Neighbors(false, false)
            )
    );
    public static Group CHERRY_SHRUB = new Group(
            0.25D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
            ...
            new Group.Entry(
                    "endemic:cherry_shrub",
                    1.0D,
                    new Group.Entry.Neighbors(false, false)
            )
    );
    public static Group PALE_OAK = new Group(
            1.0D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
    ...
    public static Group STUNTED_PALE_OAK = new Group(
            0.5D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
            ...
            new Group.Entry(
                    "endemic:stunted_pale_oak",
                    1.0D,
                    new Group.Entry.Neighbors(false, true)
            )
    );
    public static Group PALE_OAK_SHRUB = new Group(
            0.25D,
            new Group.Region(
                    new Group.Region.Dimensions(
                            Arrays.asList(),
