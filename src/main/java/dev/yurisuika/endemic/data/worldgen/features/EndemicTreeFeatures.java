...
public class EndemicTreeFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_SWAMP_OAK = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_swamp_oak"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_FANCY_OAK = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_fancy_oak"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_OAK = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_oak"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_MEGA_PINE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_mega_pine"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_MEGA_SPRUCE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_mega_spruce"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_PINE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_pine"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_SPRUCE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_spruce"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_SUPER_BIRCH = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_super_birch"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_BIRCH = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_birch"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_MEGA_JUNGLE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_mega_jungle"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_JUNGLE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_jungle"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_ACACIA = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_acacia"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_DARK_OAK = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_dark_oak"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_TALL_MANGROVE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_tall_mangrove"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_MANGROVE = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_mangrove"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_CHERRY = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_cherry"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> STUNTED_AZALEA = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_azalea"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> OAK_SHRUB = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "oak_shrub"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> SPRUCE_SHRUB = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "spruce_shrub"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> BIRCH_SHRUB = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "birch_shrub"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> JUNGLE_SHRUB = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "jungle_shrub"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> ACACIA_SHRUB = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "acacia_shrub"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> DARK_OAK_SHRUB = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "dark_oak_shrub"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> MANGROVE_SHRUB = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "mangrove_shrub"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> CHERRY_SHRUB = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "cherry_shrub"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> AZALEA_SHRUB = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "azalea_shrub"));
