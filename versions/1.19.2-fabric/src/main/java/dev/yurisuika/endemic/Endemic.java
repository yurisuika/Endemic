...
public class Endemic implements ModInitializer {
    ...
    public static void registerConfiguredFeatures() {
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_tall_mangrove"), EndemicTreeFeatures.STUNTED_TALL_MANGROVE);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_mangrove"), EndemicTreeFeatures.STUNTED_MANGROVE);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "stunted_azalea"), EndemicTreeFeatures.STUNTED_AZALEA);
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new ResourceLocation("endemic", "mangrove_shrub"), EndemicTreeFeatures.MANGROVE_SHRUB);
