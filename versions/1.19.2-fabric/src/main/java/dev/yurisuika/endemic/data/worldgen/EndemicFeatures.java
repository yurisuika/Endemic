...
public class EndemicFeatures {
    ...
    public static final ConfiguredFeature<TreeConfiguration, ?> STUNTED_TALL_MANGROVE = new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
            ...
            new TwoLayersFeatureSize(1, 0, 1))
            .ignoreVines().build());
    public static final ConfiguredFeature<TreeConfiguration, ?> STUNTED_MANGROVE = new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
            new SimpleStateProvider(Blocks.MANGROVE_LOG.defaultBlockState()),
            ...
            new TwoLayersFeatureSize(1, 0, 1))
            .ignoreVines().build());
    public static final ConfiguredFeature<TreeConfiguration, ?> MANGROVE_SHRUB = new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
            new SimpleStateProvider(Blocks.MANGROVE_LOG.defaultBlockState()),
            new StraightTrunkPlacer(1, 0, 0),
            new SimpleStateProvider(Blocks.MANGROVE_LEAVES.defaultBlockState()),
            new BushFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2),
