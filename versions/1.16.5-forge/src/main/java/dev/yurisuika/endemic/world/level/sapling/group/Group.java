...
public final class Group {
    ...
    public static final class Entry {
        ...
        public static final class Surroundings {
            ...
            public final boolean requiresFlowersNearby;
            public final boolean requiresAdjacentSaplings;

            public Surroundings(boolean requiresFlowersNearby, boolean requiresAdjacentSaplings) {
                this.requiresFlowersNearby = requiresFlowersNearby;
                this.requiresAdjacentSaplings = requiresAdjacentSaplings;
            }

            public boolean requiresFlowersNearby() {
                return requiresFlowersNearby;
            }

            public boolean requiresAdjacentSaplings() {
                return requiresAdjacentSaplings;
            }
